...
class SchedulerJobTest(unittest.TestCase):
    ...
    def test_get_pool_slots(self):
        """
        Test to make sure the pool slots are fetched correctly
        """
